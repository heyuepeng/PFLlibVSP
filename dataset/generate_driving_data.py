...
if __name__ == "__main__":
    data_dir = "./driving"
    features = ['velocity', 'has_front_vehicle', 'front_vehicle_distance', 'front_vehicle_velocity', 'has_traffic_light', 'distance_tl', 'signal_tl', 'signal_tl_1s', 'signal_tl_2s', 'signal_tl_3s', 'signal_tl_4s', 'signal_tl_5s']
    generate_client_data(data_dir, features, 5, 5)
    print("Finish generating driving dataset.\n")
