...
colors = ['#1f77b4', '#2ca02c', '#9467bd','blue' ,'#e377c2', '#bcbd22', '#7f7f7f', '#ff7f0e', '#17becf', '#ff0000']
...
for hdf5_file, name, marker, color in zip(hdf5_files, names, markers, colors):
    with h5py.File(hdf5_file, 'r') as hf:
        rs_test_mae = hf['rs_train_loss'][:201]

    plt.plot(rs_test_mae, label=name, linestyle=linestyle, marker=marker, markevery=6, linewidth=2.5, markersize=8, color=color)
